...
namespace QLDSV_HTC.Web.Services
{
    public class SidebarService : ISidebarService
    {
        public IEnumerable<MenuItem> GetMenuItems()
        {
            return
            [
                new() { Title = "Dashboard", Path = RouteConstants.Home.HomePath, Icon = "bi-speedometer2", Roles = [AppConstants.Groups.SV, AppConstants.Groups.PGV, AppConstants.Groups.KHOA] },
               ...
               // Items for PGV/KHOA (Faculty/Admin)
                new() { Title = "Lớp", Path = RouteConstants.Class.ClassPath, Icon = "bi-people", Roles = [AppConstants.Groups.PGV] },
